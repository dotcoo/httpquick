...
class HttpQuickBase {
  ...
  // 填充请求头
  fillHeaders(req) {
    if (req.responseType == 'text' && req.dataType == 'json') { req.headers.Accept = 'application/json; charset=utf-8'; }
    else if (req.responseType == 'text' && req.dataType == 'xml') { req.headers.Accept = 'application/xml; charset=utf-8'; }
    else if (req.responseType == 'text') { req.headers.Accept = 'text/plain; charset=utf-8'; }
